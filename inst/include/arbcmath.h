...
#define MAKE_COMPLEX(re,im) (std::complex<double>(re,im))
...
static __inline__ void _acb_init_set_c(acb_t z, std::complex<double> v)
{
    acb_init(z);
    acb_set_d_d(z, real(v), imag(v));
}

static __inline__ std::complex<double> _acb_get_c(const acb_t z)
{
    double re, im;
...
static __inline__ std::complex<double> ac_ ## cfun \
...
static __inline__ std::complex<double> ac_ ## cfun \
(std::complex<double> z1, std::complex<double> z2, std::complex<double> z3, std::complex<double> z4) \
{ \
