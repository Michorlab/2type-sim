...
RcppExport SEXP _sim2type_p2type(SEXP tSEXP, SEXP alpha1SEXP, SEXP beta1SEXP, SEXP nuSEXP, SEXP alpha2SEXP, SEXP beta2SEXP, SEXP ancestorsSEXP, SEXP domain_sizeSEXP, SEXP threadsSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_sim2type_p2type", (DL_FUNC) &_sim2type_p2type, 9},
    {NULL, NULL, 0}
};
